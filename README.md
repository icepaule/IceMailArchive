...
│                                                             │
│  ┌──────────┐  ┌──────────┐  ┌───────────┐  ┌──────────┐  │
│  │  Gmail    │  │  iCloud  │  │ Outlook   │  │ Eigener  │  │
│  │  IMAP     │  │  IMAP    │  │ .com IMAP │  │ IMAP-Srv │  │
│  └────┬─────┘  └────┬─────┘  └─────┬─────┘  └────┬─────┘  │
│       └──────────────┼──────────────┼─────────────┘         │
│                      │     IMAP/SSL (:993)                  │
│  ┌──────────┐        ▼                                      │
...
| Apache Tika | `apache/tika:3.2.2.0-full` | 9998 | Anhang-Textextraktion |
